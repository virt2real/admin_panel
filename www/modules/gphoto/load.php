...
for ($i=0; $i<$lines; $i++) {
	...
	if (substr($dir_parent, -1) != "/") $dir_parent .= "/";
	$dir_list .= '<tr><td class="col1" onclick="LoadDir(\''.$file_name.'\', \''.$dir_parent.'\'); return false;"><a href="#" title="'.$dir_parent.$file_name.'" onclick="LoadDir(\''.$file_name.'\', \''.$dir_parent.'\'); return false;">[ '.$file_name.' ]</a>&nbsp;</td><td class="col2">&nbsp;</td><td class="col3">&nbsp;</td></tr>';
}
