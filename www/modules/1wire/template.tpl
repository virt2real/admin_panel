...
<div id="accordion" style="margin:0; padding:0;">
	...
	<div>
		<p>
			...
			<a href="" class="buttonlink" onclick='if (!w1_timer) w1_timer = setTimeout("update_w1()", 1); return false;'>[ Запустить опрос ]</a>
			<a href="" class="buttonlink" onclick='clearTimeout(w1_timer); w1_timer = false; $("#w1loader").css("display","none"); return false;'>[ Остановить опрос ]</a>

			<p style="height:20px;"><img id="w1loader" src="/imgs/loader.gif" style="display: none;"></p>

		</p>

		<p class="bluetitle">Найденные устройства 1-Wire</p>
